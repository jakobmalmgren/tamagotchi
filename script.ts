...
// let weatherData; måste sätta rätt type...? hur ? hur tänker man här??
// måste ja in i själva obj i consolen se va jag får ut
// sen skriva i nedanför va de är?? el hur?
...
const mainContainer = document.querySelector(".main") as HTMLBodyElement;
const ghostContainer: Element | null = document.querySelector(
  ".main__screen-ghost-container"
);
const moneyContainer: Element | null = document.querySelector(
  ".main__money-section-amount"
);
const faceContainer: Element | null = document.querySelector(
  ".main__face-container"
);
const boredContainer: Element | null = document.querySelector(
  ".main__bored-container"
);
const boredBtn: Element | null = document.querySelector(".main__btn--play");
const workBtn: Element | null = document.querySelector(".main__btn--work");
const sleepyBnt: Element | null = document.querySelector(".main__btn--sleep");
const hungryBtn: Element | null = document.querySelector(".main__btn--eat");
const sleepContainer: Element | null = document.querySelector(
  ".main__sleepy-container"
);
if (ghostContainer !== null) {
  ghostContainer.innerHTML = `<i class="fa-solid fa-ghost"></i>`;
}

const info: Element | null = document.querySelector(".main__info-container__p");
if (info !== null) {
  info.innerHTML = `Name : ${spooky.name}`;
}

const restartBtn: Element | null = document.querySelector(".main__power-btn");
if (restartBtn !== null) {
...
function handleFace(hungryFace: string): void {
...
function handleSleepyFace(face: string) {
  ...
  if (sleepyExpression === "not tired" && sleepContainer !== null) {
    ...
    sleepyExpression === "litte more sleepy" &&
    sleepContainer !== null
  ) {
...
function handleBoredFace(boredFace: string) {
